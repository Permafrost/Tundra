...
// -----( CREATED: 2015-07-21 15:22:26 AEST
...

{
        ...
        throws ServiceException
	{
		...
		try {
		    ...
		    String datetime = DateTimeHelper.emit(DateTimeHelper.concatenate(DateTimeHelper.parse(date, "date"), DateTimeHelper.parse(time, "time")));
