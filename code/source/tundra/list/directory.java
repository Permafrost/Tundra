...
// -----( CREATED: 2021-08-18 10:31:05 AEST
// -----( ON-HOST: -
...

{
		    ...
		    if (directories != null) {
		        ...
		        for (IData document : directories) {
		            if (document != null) {
		                ...
		                try {
		                    File directory = IDataHelper.get(dc, "directory", File.class);
		        ...
		        IDataHelper.put(cursor, "$counts", counts.toArray(new String[0]));
		    }
        ...
        throws ServiceException
	{
		...
		try {
		    ...
		    for (String directory : directories) {
		        try {
		            DirectoryHelper.remove(FileHelper.construct(directory), recurse);
		        } catch(IOException ex) {
		            exceptions.add(ex);
		        }
		    }
        ...
        throws ServiceException
	{
		...
		try {
		    ...
		    if (directories != null) {
		        ...
		        IDataHelper.put(cursor, "$sizes.squeezed", sizes.toArray(new String[0]));
		    }
